...
call npm install gulp -S
call npm install gulp-autoprefixer -S
call npm install gulp-sourcemaps -S

call npm install jshint -S
call npm install jshint-stylish -S
call npm install gulp-jshint -S

call npm install stylus --save
call npm install stylus-type-utils --save
call npm install gulp-stylus -S
call npm install nib -S

call npm install browser-sync -S
